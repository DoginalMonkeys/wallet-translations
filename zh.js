...
export const zh = {
  translation: {
    ...
    disable_button_vibration: "禁用按钮振动反馈", // Disable button vibration
    back: "后退", // Back
    language: "语言", // Language
    app_theme: "应用主题", // App Theme
    system: "跟随系统", // System
    dark: "夜间", // Dark
    light: "日间", // Light
    settings: "设置", // Settings
    backup_and_security: "备份与安全", // Backup & Security
    manage_wallet: "管理钱包", // Manage Wallet
    profile: "档案", // Profile
    app_preferences: "应用程序偏好设置", // App Preferences
    notifications: "通知", // Notifications
    help_support: "帮助支持", // Help & Support
    about_my_doge: "关于我的 Doge", // About My Doge
    admin: "管理员", // Admin
    i_cloud: "iCloud", // iCloud
    cloud: "云", // cloud
    youve_backed_up_to: "您已备份至", // You've backed up to
    you_havent_created_a_cloud_backup: "您尚未创建云备份", // You haven't created a Cloud Backup
    manage: "管理", // Manage
    backup: "备份", // Backup
    view_seed_phrase: "查看助记词", // View Seed Phrase
    pin: "PIN", // PIN
    ...
    use_fingerprint: "使用指纹/面部识别", // Use Fingerprint/Face ID
    ask_every_time_i_open_the_app: "每次打开应用程序时询问", // Ask every time I open the app
    ...
    resend_code: "重新发送验证码", // Resend Code
    wrong_number: "错误号码", // Wrong Number
    confirm_code: "确认码", // Confirm Code
    youve_entered_the_verse: "你已经进入了诗篇", // You've entered the Verse
    youre_now_ready_to_explore_the_dogeverse: "您现在就可以探索 Dogeverse 了！", // You're now ready to explore the Dogeverse!
    lets_go: "我们走吧！", // Let's go!
    edit_profile: "编辑个人资料", // Edit Profile
    social_connect: "链接社交账户", // Social Connect
    profile_privacy: "个人资料隐私", // Profile Privacy
    profile_is_public: "公开账户", // Profile is Public
    show_wallet_address_and_tip_button: "显示钱包地址和小费按钮", // Show wallet address and Tip button
    preferences: "偏好", // Preferences
    confirm_x_tips: "确认𝕏打赏", // Confirm 𝕏 Tips
    tips_received: "收到小费", // Tips Received
    new_followers: "新的关注者", // New Followers
    new_memes: "新迷因", // New Memes
    about_mydoge: "关于MyDoge", // About MyDoge
    terms_of_use: "使用条款", // Terms of Use
    privacy_policy: "隐私政策", // Privacy Policy
    share_mydoge: "分享 MyDoge", // Share MyDoge
    visit_our_website: "访问我们的网站", // Visit Our Website
    settings_and_support: "设置和支持", // Settings and Support
    connect_twitch: "连接 Twitch", // Connect Twitch
    connect_x: "连接𝕏", // Connect 𝕏
    create_a_post: "创建帖子", // Create a Post
    following: "关注", // Following
    followers: "粉丝", // Followers
    recent_activity: "近期活动", // Recent Activity
    history: "历史", // History
    price: "价格", // Price
    usd: "美元", // USD
    txs: "交易", // TXs
    ...
    tx_hash_copied: "交易哈希已复制", // Transaction hash copied
    note_copied: "已复制注释", // Note copied
    address_copied: "地址已复制", // Address copied
    wallet: "钱包", // Wallet
    dogeverse: "狗狗宇宙", // Dogeverse
    shop: "店铺", // Shop
    receive_doge: "接收 Doge", // Receive Doge
    send_doge: "发送 Doge", // Send Doge
    ...
    save_changes: "保存更改", // Save Changes
    save_address: "保存地址", // Save Address
    enter_new_PIN: "输入新 PIN", // Enter new PIN
    confirm_new_pin: "确认新 PIN", // Confirm new PIN
    enter_new_PIN_description: "输入你的 MyDoge 钱包的新 PIN 码", // Enter your new PIN for your MyDoge wallet
    enter_old_PIN: "输入旧 PIN 码", // Enter old PIN
    enter_old_PIN_description: "输入你的 MyDoge 钱包的旧 PIN 码", // Enter your old PIN for your MyDoge wallet
    forgot_PIN: "忘记密码", // Forgot PIN
    confirm: "确认", // Confirm
    ...
    start_receive_tips_twitch: "开始在 Twitch 上接收小费", // Start receiving tips on Twitch
    visit_mydogetv_twitch: "访问 Twitch 上的 MyDogeTV 了解更多信息", // Visit MyDogeTV on Twitch for more info
    connect_with_twitch: "与 Twitch 链接", // Connect with Twitch
    screen_not_exist: "该页面不存在。", // This screen doesn't exist.
    go_to_home_screen: "转至主页面", // Go to Home Screen
    gift_cards: "礼品卡", // Gift Cards
    backup_wallet: "备份你的新钱包", // Back up your new wallet
    backup_required: "需要备份来保障你的资金安全", // A backup is required to secure your funds
    why_backups_important: "为什么备份很重要？", // Why are backups important?
    learn_about_backups: "点按了解备份", // Tap to learn about backups
    backup_to: "备份至", // Backup to
    ...
    lose_password_lose_backup: "如果您丢失此密码，您将丢失您的钱包备份。", // If you lose this password you will lose your wallet backup.
    password: "密码", // Password
    confirm_password: "确认密码", // Confirm Password
    confirm_backup: "确认备份", // Confirm Backup
    overwrite_backup_title: "覆盖现有备份吗？", // Overwrite existing backup?
    existing_wallet_overwrite_prompt: "您之前已将钱包备份到云端。要覆盖它吗？", // You have an existing wallet previously backed up to the cloud. Do you want to overwrite it?
    overwrite_backup: "覆盖备份", // Overwrite backup
    import_existing_wallet: "导入现有钱包", // Import existing wallet
    unknown_cloud_error: "未知云错误", // Unknown Cloud Error
    unknown_cloud_error_body: "备份到云时出现未知错误。", // There was an unknown error while backing up to the cloud.
    try_again_or_notify_support: "请重试或通知 MyDoge 支持。", // Please try again or notify MyDoge support.
    enter_recovery_password: "输入恢复密码", // Enter Recovery Password
    enter_cloud_password_description: "输入你在云端存储助记词的密码", // Enter the password you used to store your seed phrase on the cloud
    import_wallet: "导入钱包", // Import wallet
    imported_wallet_title: "您已导入钱包", // You've imported your wallet
    ...
    create_pin: "创建 PIN", // Create PIN
    confirm_pin: "确认 PIN", // Confirm PIN
    choose_dogeverse_username: "选择 DogeTag", // Choose a DogeTag
    dogeverse_link: "Dogeverse链接", // Your web link will be
    ...
    save_online_backup: "保存在线备份至", // Save an online backup to
    icloud: "iCloud", // iCloud
    google_drive: "Google 云端硬盘", // Google Drive
    do_this_later: "我稍后会这样做", // I'll do this later
    ...
    already_have_wallet: "我已经有钱包了", // I already have a wallet
    buy_send_receive_dogecoin: "购买、发送和接收狗狗币", // Buy, Send & Receive Dogecoin
    send_doge_tips: "在𝕏上发送 Doge 小费，安全存储您的 Doge，成为您自己的银行", // Send Doge tips on 𝕏, store your Doge safely, and be your own bank
    ...
    some_doge: "一些 Doge！", // some Doge!
    total: "全部的", // Total
    done: "完毕", // Done
    shop_with_doge: "使用Doge购物", // Shop with Doge
    oops: "哎呀！", // Oops!
    no_comments_yet: "暂时没有评论", // No comments yet
    ...
    WALLET_ADDRESS: "钱包地址", // WALLET ADDRESS
    dogetag_link: "DOGE TAG 链接", // DOGETAG LINK
    no_access_camera: "无法访问相机", // No access to camera
    enable_camera_access_ios: "为 MyDoge 启用相机访问权限", // Enable camera access for MyDoge
    grant_camera_permission_android: "请授予 MyDoge 相机权限", // Please grant camera permission to MyDoge
    ...
    invalid_address_error: "无效地址", // Invalid address
    results_title: "结果", // Results
    all: "全部", // All
    pending: "待办的", // Pending
    enter_pin: "输入 PIN", // Enter PIN
    enter_pin_to_confirm: "输入您的钱包 PIN 码进行确认", // Enter your Wallet Pin to confirm
    welcome_back: "欢迎回来", // Welcome back
    enter_wallet_pin: "输入您的钱包 PIN", // Enter your Wallet PIN
    forgot_pin: "忘记PIN", // Forgot PIN
    forgot_pin_title: "忘记PIN", // Forgot PIN
    forgot_pin_body: "您想使用生物识别技术来解锁您的钱包吗？", // Do you want to use biometrics to unlock your wallet?
    share: "分享", // Share
    address_copied_to_clipboard: "地址已复制到剪贴板", // Address copied to clipboard
    follows_you: "关注你", // Follows You
    official_mydoge_profile: "MyDoge 官方简介", // Official MyDoge Profile
    official_mydoge_commerce_profile: "MyDoge 商务官方简介", // Official MyDoge Commerce Profile
    official_foundation_profile: "基金会官方简介", // Official Foundation Profile
    follow_back: "回关", // Follow Back
    follow: "关注", // Follow
    tip: "打赏", // Tip
    share_profile: "分享档案", // Share Profile
    unfollow: "取消关注", // Unfollow
    unblock: "解除屏蔽", // Unblock
    block_or_report: "屏蔽或举报", // Block or Report
    copy_profile_url: "复制个人资料网址", // Copy Profile URL
    memes_error: "加载表情包时出错。请返回并重试。", // Error loading memes. Please go back and try again.
    ...
    amount: "数量", // Amount
    custom: "自定义", // Custom
    add_a_message: "添加消息", // Add a message
    find_friends: "找朋友", // Find friends
    cancel: "取消", // Cancel
